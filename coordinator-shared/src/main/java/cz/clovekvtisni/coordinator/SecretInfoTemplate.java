package cz.clovekvtisni.coordinator;

// Template for the file SecretInfo.java, which is not part of the version
// control system, because it contains secrets like passwords and API keys.
