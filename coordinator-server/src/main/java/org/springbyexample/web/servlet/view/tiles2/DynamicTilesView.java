...
public class DynamicTilesView extends AbstractUrlBasedView {
    ...
    public void setContentNameVariable(String var) {
        dynamicTilesViewProcessor.setContentNameVariable(var);
    }

    public void setViewNameVariable(String var) {
        dynamicTilesViewProcessor.setViewNameVariable(var);
    }
