                        ...
                        <c:forEach items="${userInEvents}" var="userInEvent" begin="0" step="1" varStatus="i">
                            <tr
                                <c:if test="${!empty userInEvent.lastLocationLatitude and !empty userInEvent.lastLocationLongitude}">
                                    onclick="CoordinatorMap.goTo(${userInEvent.lastLocationLongitude}, ${userInEvent.lastLocationLatitude}); CoordinatorMap.focusPoint('usr'+${userInEvent.userId});" class="clickable"
                                </c:if>
                            >
